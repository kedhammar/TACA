...
class TestBackupUtils(unittest.TestCase):
    ...
    def test_fetch_config_info(self):
        ...
        config_info = backup.backup_utils(
            "data/nas/miseq.lab/190201_A00621_0032_BHHFCFDSXX"
        )
        self.assertEqual(config_info.data_dirs, {"miseq": "data/nas/miseq.lab"})
        self.assertEqual(
            config_info.archive_dirs,
            {"hiseq": "blah", "miseq": "data/nas/miseq.lab/nosync"},
        )
    ...
    def test_collect_runs_specific_run(self):
        ...
        backup_object = backup.backup_utils(
            run="data/nas/miseq.lab/nosync/200201_A00621_0032_BHHFCFDSXX"
        )
    ...
    def test_avail_disk_space(self, mock_misc, mock_sp):
        ...
        mock_sp.return_value = [
            "Filesystem   512-blocks      Used Available Capacity iused      ifree %iused  Mounted on\n/dev/disk1s1  976490576 100 813074776    15% 1086272 4881366608    0%   /System/Volumes/Data",
            None,
        ]
    ...
    def test_call_commands(self):
        ...
        backup_object = backup.backup_utils()
        got_output = backup_object._call_commands(
            cmd1="ls data/nas/miseq.lab", mail_failed=False, return_out=True
        )
    ...
    def test_check_status(self):
        ...
        status_pass = 0
        err_msg = "Error"
        got_status_pass = backup_object._check_status(
            cmd, status_pass, err_msg, mail_failed=False
        )
        self.assertTrue(got_status_pass)
        status_fail = 1
        got_status_fail = backup_object._check_status(
            cmd, status_fail, err_msg, mail_failed=False
        )
    ...
    def test_clean_tmp_files(self, mock_remove):
        ...
        backup_object = backup.backup_utils()
        files = [
            "data/nas/miseq.lab/190201_A00621_0032_BHHFCFDSXX/RTAComplete.txt",
            "data/nas/miseq.lab/190201_A00621_0032_BHHFCFDSXX/missing_file.txt",
        ]

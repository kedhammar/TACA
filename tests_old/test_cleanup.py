...
class TestCleanup(unittest.TestCase):
    ...
    def test_cleanup_miarka(
        self, mock_touch, mock_rm, mock_query, mock_info, mock_statusdb
    ):
        ...
        calls = [
            mock.call(
                "data/miarka/incoming/190201_A00621_0032_BHHFCFDSXX/Demultiplexing/N.Owens_19_01"
            ),
            mock.call("../../nobackup/NGI/ANALYSIS/P1234"),
        ]
        cleanup.cleanup_miarka(
            days_fastq,
            days_analysis,
            only_fastq,
            only_analysis,
    ...
    def test_collect_analysis_data_miarka(self):
        ...
        file_list, size = cleanup.collect_analysis_data_miarka(
            pid, analysis_root, files_ext_to_remove={}
        )
        ...
        expected_data = {
            "flowcells": {
                "190201_A00621_0032_BHHFCFDSXX": {
                    ...
                    "fq_files": [
                        "data/test_data/190201_A00621_0032_BHHFCFDSXX/N.Owens_19_01/sample1.fastq.gz",
...
"""
    ...
    def test_get_files_size_text(self):
        ...
        plist = {
            "P1": {"fastq_size": 1001, "analysis_size": 1000000},

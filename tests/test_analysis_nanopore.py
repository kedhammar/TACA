...
class TestNanoporeAnalysis(unittest.TestCase):
    def test_find_runs_to_process(self):
        ...
        expected_dirs = [
            "data/nanopore_data/run1/still_sequencing/20200101_1412_MN19414_AAU641_68125dc2",
    ...
    def test_process_minion_run_transfer(
        self, mock_mail, mock_archive, mock_update, mock_transfer, mock_cp
    ):
        ...
        expected_calls = [
            mock.call(
                "Anglerfish successfully processed run 20200104_1412_MN19414_AAU644_68125dc2",
                "Anglerfish has successfully finished for run 20200104_1412_MN19414_AAU644_68125dc2. Please finish the QC step in lims.",
                "test@test.com",
            ),
            mock.call(
                "Run successfully processed: 20200104_1412_MN19414_AAU644_68125dc2",
